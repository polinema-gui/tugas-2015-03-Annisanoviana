Public Class Matriks
    ...
    Private Sub btn_proses_Click(sender As Object, e As EventArgs) Handles b_proses.Click
        Try
            Dim barisMatriks1 As Integer = t_m1.Lines.Count
            Dim kolomMatriks1 As Integer = t_m1.Lines.ElementAt(0).Split(" ").Length
            Dim barisMatriks2 As Integer = t_m1.Lines.Count
            Dim kolomMatriks2 As Integer = t_m1.Lines.ElementAt(0).Split(" ").Length
        ...
        If (Me.cekKolom) Then
            For baris As Integer = 0 To baris1 - 1
                For kolom As Integer = 0 To kolom1 - 1
                    nilai1(baris, kolom) = t_m1.Lines.ElementAt(baris).Split(" ").ElementAt(kolom)
                    nilai2(baris, kolom) = t_m2.Lines.ElementAt(baris).Split(" ").ElementAt(kolom)
                Next
            Next
        End If
    End Sub
    ...
    Private Sub cek(ByVal baris1 As Integer, baris2 As Integer, kolom1 As Integer, kolom2 As Integer)
        ...
        For baris = 0 To baris1 - 2
            If (t_m1.Lines.ElementAt(baris).Split(" ").Length <> t_m1.Lines.ElementAt(baris + 1).Split(" ").Length) Then
                tmp = False
            End If
        Next
        For baris = 0 To baris2 - 2
            If (t_m2.Lines.ElementAt(baris).Split(" ").Length <> t_m2.Lines.ElementAt(baris + 1).Split(" ").Length) Then
                tmp = False
            End If
        Next
        If (tmp = False) Then
            Me.cekKolom = False
            Convert.ToInt32(t_m1.Text)
            Convert.ToInt32(t_m2.Text)
    ...
    Private Sub Txb_hasil_TextChanged(sender As Object, e As EventArgs) Handles t_h.TextChanged

    End Sub

    Private Sub Cmb_operasi_SelectedIndexChanged(sender As Object, e As EventArgs) Handles c_operasi.SelectedIndexChanged

    End Sub

    Private Sub Txb_matrik1_TextChanged(sender As Object, e As EventArgs) Handles t_m1.TextChanged
    ...
    Private Sub Txb_matrik2_TextChanged(sender As Object, e As EventArgs) Handles t_m2.TextChanged
